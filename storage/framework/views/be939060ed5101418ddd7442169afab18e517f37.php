        ...
        <div class="col-lg-8 order-lg-2">
            ...
            <div class="tab-content py-4">
                <div class="tab-pane active" id="profile">
                    <h5 class="mb-3">Смена пароля <?php echo e($user->name); ?></h5>
                    <form action="/<?php echo e($lang); ?>/update_password" method="POST" enctype="multipart/form-data">
...
<?php /**PATH D:\OpenServer\domains\enbek\resources\views/app/pages/page/profile/change_password.blade.php ENDPATH**/ ?>