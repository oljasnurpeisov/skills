...
<div class="container">
    ...
    <div class="row my-2">
        <div class="col-lg-8 order-lg-2">
            ...
            <div class="tab-content py-4">
                <div class="tab-pane active" id="profile">
                    ...
                    <form action="/<?php echo e($lang); ?>/update_profile" method="POST" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>

                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <b><label for="name">ФИО</label></b>
                                    <input type="text" class="form-control" name="name"
                                           placeholder="Введите ФИО" value="<?php echo e($user->name); ?>">
                                </div>
                                <div class="form-group">
                                    <b><label for="Email">E-mail</label></b>
                                    <input type="email" class="form-control" name="email"
                                           placeholder="Введите email" value="<?php echo e($user->email); ?>">
                                </div>
                                <div class="form-group">
                                    <b><label for="iin">ИИН/БИН</label></b>
                                    <input type="text" class="form-control" name="iin"
                                           placeholder="Введите ИИН/БИН" value="<?php echo e($user->iin); ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type_of_ownership">
                                        <?php $__currentLoopData = $types_of_ownership; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type->id); ?>"
                                                    <?php if($type->id==$user->type_ownership->id): ?> selected='selected' <?php endif; ?> ><?php echo e($type->getAttribute('name_'.$lang) ??  $type->getAttribute('name_ru')); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="company_name"
                                           placeholder="Введите название организации" value="<?php echo e($user->company_name); ?>">
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-4 order-lg-1 text-center">
            <img src="<?php echo $user->company_logo; ?>" class="mx-auto img-fluid img-circle d-block" alt="avatar" id="company_logo_img" width="200" height="100">
            <br>
            <div class="form-group">
...
<?php /**PATH D:\OpenServer\domains\enbek\resources\views/app/pages/page/profile/edit_profile.blade.php ENDPATH**/ ?>