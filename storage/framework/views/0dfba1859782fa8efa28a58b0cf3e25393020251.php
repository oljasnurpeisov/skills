<?php $__env->startSection('title',__('admin.pages.users.title').' | '.__('admin.site_name')); ?>
    ...
    <div class="container container-fluid">
        <div class="title-block">
            <div class="row row--multiline align-items-center">
                <div class="col-md-4">
                    <h1 class="title-primary" style="margin-bottom: 0"><?php echo e(__('admin.pages.users.title')); ?></h1>
                </div>
                <div class="col-md-8 text-right-md text-right-lg">
                    <div class="flex-form">
                        <div>
                            <form action="/<?php echo e($lang); ?>/admin/user/index" method="get" class="input-button">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="/<?php echo e($lang); ?>/admin/user/<?php echo e($item->id); ?>" title="<?php echo e(__('admin.labels.edit')); ?>"
                                       class="icon-btn icon-btn--yellow icon-edit"></a>
                                    <a href="/<?php echo e($lang); ?>/admin/user/<?php echo e($item->id); ?>"
...
<?php echo $__env->make('admin.v2.layout.default.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\enbek\resources\views/admin/v2/pages/users/index.blade.php ENDPATH**/ ?>