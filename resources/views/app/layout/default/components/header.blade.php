<header class="header">
    <div class="container">
        ...
        <ul class="menu">
            <li><a href="#" title="Профиль">Профиль</a></li>
            <li @if(basename(request()->path()) == 'my-courses')class="active"@endif><a href="/{{$lang}}/my-courses" title="{{__('default.pages.courses.my_courses_title')}}">{{__('default.pages.courses.my_courses_title')}}</a></li>
        </ul>
        <div class="buttons-group">
            ...
            <div class="header-dropdown notifications">
                ...
                <div class="header-dropdown__desc">
                    <ul>
                        ...
                        <li><span>Текст уведомления <a href="#" title="Ссылка в уведомлении">Ссылка в уведомлении</a> продолжение текста</span></li>
                        <li class="break"><hr></li>
                        <li><span>Добро пожаловать на сервис Enbek.kz</span></li>
                        <li class="break"><hr></li>
                        <li><a href="/notifications.html" title="Все уведомления" class="blue">Все уведомления <i class="icon-chevron-right"> </i></a></li>
                    </ul>
                </div>
            </div>
            <div class="header-dropdown profile">
                ...
                <div class="header-dropdown__desc">
                    <div class="name">{{Auth::user()->author_info->name}}</div>
                    <hr>
                    <ul>
                        <li><a href="/{{$lang}}/my-courses/statistics" title="{{__('default.pages.statistics.title')}}">{{__('default.pages.statistics.title')}}</a></li>
                        ...
                        <li><a href="#" title="{{__('default.pages.dialogs.title')}}">{{__('default.pages.dialogs.title')}}</a></li>
                        <li><a href="/{{$lang}}/my-courses/reporting" title="{{__('default.pages.reporting.title')}}">{{__('default.pages.reporting.title')}}</a></li>
                        <li><a href="#" title="{{__('notifications.title')}}">{{__('notifications.title')}}</a></li>
                        <li class="break"><hr></li>
                        <li><a href="/{{$lang}}/logout" title="{{__('default.pages.profile.logout_title')}}">{{__('default.pages.profile.logout_title')}}</a></li>
                    </ul>
                </div>
            </div>
