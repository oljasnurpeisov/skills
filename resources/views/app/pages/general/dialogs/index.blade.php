...
<div class="container">
    ...
    <div class="row my-2">
        ...
        @foreach($items as $item)
            <div class="container">
                <div class="card">
                    <a href="/{{ $lang }}/dialog/opponent-{{ $item->opponent()->id }}" style="color:black; text-decoration: none;">
                        <div class="card-body">
                            <p><b>{{$item->opponent()->name}}</b></p>
                            <p>{{ json_decode('"'.str_replace('"','\"',$item->lastMessageText()).'"') }}</p>
                        </div>
                    </a>
                </div>
                <br>
