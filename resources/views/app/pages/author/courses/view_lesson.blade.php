            ...
            <div class="container">
                ...
                <div class="row row--multiline">
                    <div class="col-md-8">
                        ...
                        <form action="/{{$lang}}/course-{{$item->id}}/theme-{{$theme->id}}/lesson-{{$lesson->id}}/delete-lesson-form" method="POST">
                            @csrf
                            @method('DELETE')
                        <div class="row row--multiline">
                            <div class="col-auto">
                                <a href="/{{$lang}}/my-courses/course/{{$item->id}}/theme-{{$theme->id}}/edit-lesson-{{$lesson->id}}" title="{{__('default.pages.courses.edit_title')}}"
                                   class="ghost-btn">{{__('default.pages.courses.edit_title')}}</a>
                            </div>
                            <div class="col-auto">
                                <button type="submit" title="{{__('default.pages.courses.delete_title')}}"
                                        class="ghost-btn" style="background-color: white">{{__('default.pages.courses.delete_title')}}</button>
                            </div>
                        </div>
                        </form>
                    </div>
                            ...
                            <div class="sidebar__inner">
                                <div class="poor-vision">
                                    ...
                                    <div id="poorVision" style="display:none;">
                                        ...
                                        <div class="sidebar-item">
                                            <div class="sidebar-item__title">{{__('default.pages.lessons.font')}}:</div>
                                            <div class="sidebar-item__body">
                        ...
                        <div class="sidebar">
                            <div class="sidebar__inner">
                                                ...
                                                <ul>
                                                    @if(!empty($lesson->lesson_attachment->another_files))
                                                        @foreach(json_decode($lesson->lesson_attachment->another_files) as $file)
                                                            <li><a href="{{env('APP_URL').$file}}" title="{{basename($file)}}" target="_blank">{{basename($file)}} </a>
                                ...
                                <div id="poorVisionMaterials" style="display:none;">
                                    <div class="sidebar-item">
                                        <div class="sidebar-item__title">{{__('default.pages.lessons.media_attachments_poor_vision')}}:</div>
                                        <div class="sidebar-item__body">
                                    ...
                                    <div class="sidebar-item">
                                        <div class="sidebar-item__title">{{__('default.pages.lessons.lesson_files_poor_vision')}}:</div>
                                        <div class="sidebar-item__body">
                                            <div class="plain-text">
                                                <ul>
                            ...
                            <div class="sidebar__buttons">
                                <a href="#" title="Купить" class="sidebar-btn disabled">Следующий урок</a>
                            </div>
                        </div>
                    </div>
                </div>
