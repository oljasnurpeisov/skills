...
">
                ...
                <tr>
                    <td style="padding-bottom: 30px;"><a href="{{env('APP_URL')}}" title=""><img
                                    src="http://dev14.panama.kz/assets/img/logo.png" alt=""></a></td>
                </tr>
                <tr>
                    <td>
                        ...
                        <p style="
    margin: 0;
">{{__('auth.pages.verification_description')}}</p>
                        <p style="
    margin: 0;
"><a href="{{$url}}" title="" target="_blank" style="
    color: #2ab5f6;
    text-decoration: none;
">{{__('auth.pages.verification_title')}}</a></p>
                        <br>
                        <p style="
    margin: 0;
">&nbsp;{{__('auth.pages.ignore_message')}}</p>
                    </td>
                </tr>
                </tbody>
            </table>
