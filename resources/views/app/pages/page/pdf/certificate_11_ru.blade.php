                ...
                <table>
                    <td width="50%" style="padding: 0 5px 0 0;">
                        ...
                        <div class="diploma__text_column " style="width: 100%; position: relative;">
                            ...
                            <div class="diploma__text_field_label" style="display: inline-block; line-height: 7px; padding: 6px 0 1px">Сәйкестендіру номері/Идентификационный номер
                            </div>
                            <span class="diploma__text_field diploma__text_field_full"
                                  style="width: 200px;border-radius: 10px;text-align: center;padding: 0; margin-top: 0px; float: right;">{{$data['certificate_id']}}
                                </span>
                            <div class="diploma__text_field_label" style="padding-top: 4px">Берілген күні/Дата выдачи
                                <span style="">«</span>
                    ...
                    <td width="50% ">
                        <div style="position: relative; ">
                            <img src="{{public_path('/assets/img/certificates/cert-logo.png')}}"
                                 style="width: 250px; right: 20px;position: absolute; top: 7px; ">
                        </div>
                    </td>
                </table>
            </div>
