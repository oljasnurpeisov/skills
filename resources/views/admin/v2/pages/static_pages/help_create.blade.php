...
@section('content')
    <div class="container container-fluid">
        <ul class="breadcrumbs">
            ...
            <li class="active">{{ __('admin.pages.static_pages.add_theme_title') }}</li>
        </ul>
        @include('admin.v2.partials.components.warning')
        @include('admin.v2.partials.components.errors')
        <form id="mainEdit" action="/{{$lang}}/admin/static-pages/store-help-view/{{$item->id}}" method="post"
                                    ...
                                    <div id="tabs_{{$lang_key}}">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea name="tab_description_{{$lang_key}}[]"
                                                      ...
                                                      class="input-regular tinymce-text-here"></textarea>
                                        </div>
                                    </div>
                                </div>
