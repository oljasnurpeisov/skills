                    ...
                    <div class="tabs-contents">
                        ...
                        <div>
                            <div class="input-group">
                                ...
                                <input disabled type="text" class="input-regular" value="{{ $item->type_ownership->name_ru ?? '' }}">
                            </div>

                            <div class="input-group">
                                <label class="input-group__title">{{__('default.pages.auth.company_name')}} *</label>
                                <input disabled type="text" name="company_name" placeholder="" class="input-regular" required value="{{ old('company_name') ?? $item->company_name }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{ __('default.pages.profile.address') }} (ru) *</label>
                                <input disabled type="text" name="legal_address_ru" placeholder="" class="input-regular" required value="{{ old('legal_address_ru') ?? $item->legal_address_ru }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{ __('default.pages.profile.address') }} (kz) *</label>
                                <input disabled type="text" name="legal_address_kk" placeholder="" class="input-regular" required value="{{ old('legal_address_kk') ?? $item->legal_address_kk }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.profile.position')}} (ru) *</label>
                                <input disabled type="text" name="position_ru" placeholder="" class="input-regular" required value="{{ old('position_ru') ?? $item->position_ru }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.profile.position')}} (kz) *</label>
                                <input disabled type="text" name="position_kk" placeholder="" class="input-regular" required value="{{ old('position_kk') ?? $item->position_kk }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.profile.fio_director')}} *</label>
                                <input disabled type="text" name="fio_director" placeholder="" class="input-regular" required value="{{ old('fio_director') ?? $item->fio_director }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.profile.base')}} *</label>
                                <input disabled type="text" class="input-regular" value="{{ $item->base->name_ru ?? '' }}">
                            </div>
                            <br>
                            <div class="form-group">
                                <a href="{{ asset($item->base_file) }}" target="_blank" class="btn">{{__('default.download_file') }}</a>
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.auth.iin')}} *</label>
                                <input disabled type="text" name="iin" placeholder="" onfocus="$(this).inputmask('999999999999')" class="input-regular" required value="{{ old('iin') ?? $item->iin }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.profile.iik_kz')}} *</label>
                                <input disabled type="text" name="iik_kz" placeholder="" onfocus="$(this).inputmask('KZ 999999999999999999')" class="input-regular" required value="{{ old('iik_kz') ?? $item->iik_kz }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.profile.kbe')}} *</label>
                                <input disabled type="text" name="kbe" placeholder="" onfocus="$(this).inputmask('99')" class="input-regular" required value="{{ old('kbe') ?? $item->kbe }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.profile.bik')}} *</label>
                                <input disabled type="text" name="bik" placeholder="" onfocus="$(this).inputmask('9|A{1,100}')" class="input-regular" required value="{{ old('bik') ?? $item->bik }}">
                            </div>

                            <div class="form-group">
                                <label class="input-group__title">{{__('default.pages.profile.bank_name')}} *</label>
                                <input disabled type="text" class="input-regular" value="{{ $item->bank->name_ru ?? '' }}">
                            </div>
                        </div>
                    </div>
