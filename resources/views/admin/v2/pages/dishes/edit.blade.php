...
@section('content')
    <div class="container container-fluid">
        ...
        <form action="/admin/dish/{{ $item->id }}" method="post"
                    ...
                    <select name="producer_id" id="producer_id" class="input-regular chosen" data-placeholder=" "
                        ...
                        @foreach($companies as $company)
                            <option value="{{ $company->id }}"
                                    @if($item->producer_id === $company->id) selected @endif>{{ $company->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="block">
                <div class="buttons">
                    ...
                    <div>
                        <a href="/admin/dish/{{ $item->id }}" class="btn btn--red btn--delete">
