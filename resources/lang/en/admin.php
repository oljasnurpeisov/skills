...
return [
    ...
    'pages' => [
        ...
        'courses' => [
            ...
            'course_quota_title' => 'Доступен при гос.поддержке',
            '0' => 'Черновик',
            '1' => 'На проверке',
            '2' => 'Не опубликован',
            '3' => 'Опубликован',
            ...
            'quota_request_title' => 'Запросить доступ к курсу по гос.поддержке',
        ...
        'reports' => [
            ...
            'courses_by_quota_count' => 'Количество доступных при.гос.поддержке',
            ...
            'quota_access' => 'Доступен при гос.поддержке',
            ...
            'course_date' => 'Дата записи на курс',
            'first_lesson_date' => 'Дата начала обучения (дата открытия первого урока)',
            'first_failed_test_date' => 'Дата прохождения 1 итогового тестирования без достижения порогового уровня',
            'second_failed_test_date' => 'Дата прохождения 2 итогового тестирования без достижения порогового уровня',
            'third_failed_test_date' => 'Дата прохождения 3 итогового тестирования без достижения порогового уровня',
            'certificate_date' => 'Дата получения сертификата',
            'quota_course' => 'ГП',
