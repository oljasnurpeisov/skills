...
по гос.поддержке для определенных групп населения, утвержденных Министерством труда и социальной защиты населения. Базовая стоимость Вашего курса пр гос.поддержке - <b>:course_quota_cost</b> тг.
<br><br>
Стоимость курса по гос.поддержке рассчитывается автоматически в зависимости от формата и длительности Вашего курса учётом соответствующих коэффициентов качетсва учебного контента при помощи утвержденного <a href="/:lang/for-authors#calculator" target="_blank">калькулятора</a> стоимости.
Предоставление Вашего курса по специальной квоте количество охвата потенциальных обучающихся по Вашим курсамстоимости. Предоставление Вашего курса по гос.поддержке количество охвата потенциальных обучающихся по Вашим курсам.',
